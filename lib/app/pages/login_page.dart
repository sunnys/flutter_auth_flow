...
import 'package:flutter_auth_flow/app/pages/home_page.dart';
...
import 'package:flutter_auth_flow/app/validators/email_validator.dart';
import 'package:flutter_auth_flow/app/components/error_box.dart';
import 'package:flutter_auth_flow/app/components/email_field.dart';
import 'package:flutter_auth_flow/app/components/password_field.dart';
import 'package:flutter_auth_flow/app/components/login_button.dart';
...
class LoginPageState extends State<LoginPage> {
	...
	_authenticateUser() async {
		_showLoading();
		if(_valid()) {
			var response = await NetworkUtils.authenticateUser(
      ...
      var responseHeaders = response.headers;
			...
			if(responseJson == null) {
				...
				AuthUtils.insertDetails(_sharedPreferences, responseHeaders, responseJson);
				/**
